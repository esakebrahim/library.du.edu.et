...
if (isset($_SESSION['teacher_id'], $_POST['id'])) {
    // Connect to database
    ...
    $user_id = intval($_SESSION['teacher_id']); // Assuming user_id is stored in session upon login
    ...
    if ($user_type !== 'teacher') {
        echo "Only teachers can reserve books.";
        exit();
    }
